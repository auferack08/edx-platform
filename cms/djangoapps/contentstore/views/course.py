...
class GroupConfiguration(object):
    ...
    def get_usage_info(course, store):
        ...
        """
        split_tests = store.get_items(course.id, category='split_test')
    ...
    @staticmethod
    def get_validation_messages(split_test):
        """
    ...
    def _get_usage_info(store, course, split_tests):
        ...
        {'user_partition_id':
            [
                {'label': 'Unit Name / Experiment Name', 'url': 'url_to_unit_1', 'validation': [u'Validation message.']},
                {'label': 'Another Unit Name / Another Experiment Name', 'url': 'url_to_unit_1','validation': []}
            ],
        }
        """
        usage_info = {}
        ...
        for split_test in split_tests:
            ...
            usage_info[split_test.user_partition_id].append({
                ...
                'url': unit_url,
                'validation': GroupConfiguration.get_validation_messages(split_test)
            })
        return usage_info
